...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--save-figures", dest="save_figures", action="store_true", help="Save output figures after optimization.")
    parser.add_argument("--no-save-figures", dest="save_figures", action="store_false", help="Disable saving convergence/pattern figures.")
    parser.add_argument(
        "--figure-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        dest="save_abs_gamma",
        action="store_false",
        help="Disable saving ABS(gamma) plot.",
    )
    parser.add_argument(
        "--cvx-gamma-file",
        type=Path,
    ...
    parser.set_defaults(save_figures=True, save_abs_gamma=True)
...
if __name__ == "__main__":
    ...
    print("figure output directory:", args.figure_dir.resolve())
